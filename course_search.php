...
// Retrieves course and sanitises it
$course=test_input(mysqli_real_escape_string($dbconnect, $_POST['course']));
    
$find_sql="SELECT * FROM `L1_DB_assess_TreRus` WHERE `Course` LIKE '%$course%' ORDER BY `course` ASC ";
