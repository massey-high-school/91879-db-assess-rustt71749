...
// Retrieves vege and sanitises it
$vege=test_input(mysqli_real_escape_string($dbconnect, $_POST['vege']));
    
$find_sql="SELECT * FROM `L1_DB_assess_TreRus` WHERE `Vege` LIKE '%$vege%' ORDER BY `vege` ASC ";
